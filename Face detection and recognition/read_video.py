...
# Assert all the provided values are of correct types, and are valid.
  assert (type(seconds_per_frame) == int or type(seconds_per_frame) == float), "The provided seconds_per_frame value must be an number larger than 0"
...
# Create all the necessary variables
  ...
  fps = 30
  frame_interval = int(seconds_per_frame * fps)  # the amount of frames we will skip in-between converting chosen frames
